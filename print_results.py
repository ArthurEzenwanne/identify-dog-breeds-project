...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print('\n\n*** Results Summary for CNN Model Architecture', model.upper(), 
          '***')
    print('{:20}: {:4d}'.format('N Images', results_stats_dic['n_images']))
    print('{:20}: {:4d}'.format('N Dog Images', results_stats_dic['n_dogs_img']))
    ...
    #          results_stats_dic
    #
    print('{:20}: {:4d}'.format('N Not-Dog Images', results_stats_dic['n_notdogs_img']))
